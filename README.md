...
---------------+-----------+--------+-----+----------+---------+------------+-----------+-------------+---------------+--------------+------------+--------------+-------+----------+---------+----------------------------------
        ...
        0.9935 | adamw     | 16,000 | 128 |        2 |     250 |     0.4551 |    0.9441 |     0.00002 |             - |      0.08073 |     3.1162 |       3.2498 | 1e-04 |    19.76 | done    | plan_adam_eps1e17_16k_bs128      
        ...
        0.8580 | adamw     | 16,000 | 256 |        2 |     125 |          - |   -0.0407 |           - |             - |            - |     2.8529 |       3.0019 | 1e-04 |    20.72 | done    | plan_adam_eps1e17_16k_gpt2-medium
        ...
        0.9959 | adamw     | 16,000 | 256 |        4 |     250 |     0.4730 |    0.9534 |           - |             - |            - |     3.0838 |       3.2505 | 1e-04 |    25.16 | done    | plan_adam_eps1e17_16k_ep4        
        0.9950 | adamw     | 16,000 | 512 |        2 |      63 |     0.4142 |    0.9233 |     0.00017 |             - |      0.07413 |     3.1700 |       3.2751 | 2e-04 |    20.83 | done    | plan_adam_eps1e17_16k_bs512      
        0.9866 | adamw     | 32,000 |  32 |        2 |    2000 |          - |         - |           - |             - |            - |          - |            - | 5e-05 |        - | planned | plan_adam_eps1e17_32k_bs32       
        0.9937 | adamw     | 32,000 | 256 |        2 |     250 |     0.4127 |    0.9529 |           - |             - |            - |     3.1074 |       3.2363 | 2e-04 |    36.51 | done    | plan_adam_eps1e17_32k_bs256      
        0.9869 | adamw     | 64,000 |  32 |        2 |    4000 |          - |         - |           - |             - |            - |          - |            - | 3e-05 |        - | planned | plan_adam_eps1e17_64k_bs32       
        0.9876 | adamw     | 64,000 | 256 |        2 |     500 |          - |         - |           - |             - |            - |          - |       3.2314 | 1e-04 |        - | planned | plan_adam_eps1e17_64k_bs256      
        ...
        0.9939 | muon      | 16,000 |  16 |        2 |    2000 |     0.4276 |    0.8850 |     0.00121 |             - |      0.06771 |     3.0518 |       3.2440 | 5e-05 |    26.13 | done    | plan_muon_eps1e17_16k_bs16       
        ...
        0.9941 | muon      | 32,000 |  32 |        2 |    2000 |          - |         - |           - |             - |            - |          - |            - | 5e-05 |        - | planned | plan_muon_eps1e17_32k_bs32       
        0.9948 | muon      | 32,000 | 256 |        2 |     250 |     0.4044 |    0.8715 |           - |             - |            - |     3.1013 |       3.2372 | 2e-04 |    31.95 | done    | plan_muon_eps1e17_32k_bs256      
...
30 rows shown, 23 with all three metrics. '-' = not yet measured.
```
