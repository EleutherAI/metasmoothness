...
```
run                               | optimizer |    lr | N docs |  bs | N epochs | N steps | metasmoothness | EK-FAC LDS | MAGIC LDS | MAGIC filt z | EK-FAC filt z | train loss | heldout loss | delta L2 | status 
----------------------------------+-----------+-------+--------+-----+----------+---------+----------------+------------+-----------+--------------+---------------+------------+--------------+----------+--------
plan_adam_eps1e17_4k_bs256        | adamw     | 1e-04 |  4,000 | 256 |        2 |      32 |         0.9946 |     0.3975 |    0.9295 |         30.4 |          13.6 |     3.2064 |       3.3149 |     8.04 | done   
plan_adam_eps1e17_8k_bs256        | adamw     | 2e-04 |  8,000 | 256 |        2 |      63 |         0.9924 |     0.3869 |    0.9163 |         55.2 |          21.5 |     3.1309 |       3.2851 |    20.58 | done   
...
sm_adamw_eps1e17_16k_bs256        | adamw     | 2e-04 | 16,000 | 256 |        2 |     125 |         0.9930 |     0.4253 |    0.9411 |            - |             - |     3.1078 |       3.2572 |    27.23 | done   
...
plan_muon_eps1e17_8k_bs256        | muon      | 2e-04 |  8,000 | 256 |        2 |      63 |         0.9962 |     0.3881 |    0.7712 |            - |             - |     3.1560 |       3.2841 |    11.95 | done   
...
26 rows shown, 19 with all three metrics. '-' = not yet measured.
```
