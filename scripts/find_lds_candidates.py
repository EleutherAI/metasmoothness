...
E = ["/data/anon/paper_runs/experiments", "/data/anon/paper_runs/experiments"]
rows = {r["run_id"]: r for r in csv.DictReader(open("/data/anon/metasmoothness/experiments.csv"))}
