...
EXP = ["/data/anon/paper_runs/experiments",
       "/data/anon/paper_runs/experiments"]
...
# Random-removal control size: THREE (Anon, 2026-08-25). Measured from every
...
# Sustained writes to /mnt/ssd-1 are what wedged node-x-0 and BOTH 4000-step
...
# node-x-0 idle: training there was fine, but each filter job needed query_20.hf
...
MIRROR = Path("/data/anon/datasets_local")
