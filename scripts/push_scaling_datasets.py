...
Usage:
    python push_scaling_datasets.py [--repo anonymous/bergson-smollm2-scaling] [--private]
"""
...
def main() -> None:
    ...
    ap.add_argument("--repo", default="anonymous/bergson-smollm2-scaling")
    ap.add_argument("--datasets_dir",
                    default="/data/anon/bergson-damping/runs/ekfac_vs_n/datasets")
