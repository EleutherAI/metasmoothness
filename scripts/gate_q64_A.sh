#!/bin/bash
# Gate-time chain for qwen 64k plan A. Run as anon on anon-ord. Stops at the first failure.
set -e; PY=/data/anon/envs/paper/bin/python; M=/data/anon/metasmoothness/scripts; E=/data/anon/paper_runs/experiments/qwen15b_64k_bs256; cd /tmp
