...
ROOT = Path("/data/anon/ood_mean_scaling/reshard_validation/wikitext103_512k")
SOURCE_CONFIG = Path(
    "/data/anon/ood_mean_scaling/wikitext103_fixed/512k/score.yaml"
)
SOURCE_DATA = Path("/data/anon/datasets_local/train_512k.hf")
ORIGINAL_HESSIAN = Path(
    "/data/anon/paper_runs/experiments/plan_adam_eps1e17_512k_bs256/ekfac_scores/hessian"
)
RESHARDED_HESSIAN = Path("/data/anon/ood_mean_scaling/hessians_8/512k")
