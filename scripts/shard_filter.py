...
with no code change -- Anon's suggestion, and it is the whole trick.
...
ap.add_argument("--mirror", default="/data/anon/datasets_local")
...
root = None
for base in ("/data/anon/paper_runs/experiments",
