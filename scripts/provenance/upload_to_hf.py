...
Each N gets ONE model repo under Anonymous, with the fully-trained model under
...
Run:
    python scripts/ekfac_vs_n/upload_to_hf.py \
        ...
        --repo anonymous/bergson-smollm2-lds-4k
"""
...
DATA_REPO = "anonymous/bergson-smollm2-lds-chunks"
