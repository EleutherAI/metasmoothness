...
Same recipe as notes/dataset_provenance.md -- corpus anonymous/SmolLM2-135M-10B,
...
sys.path.insert(0, "/data/anon/bergson-damping")
...
raw = load_dataset("anonymous/SmolLM2-135M-10B", split=f"train[:{RAW_DOCS}]")
