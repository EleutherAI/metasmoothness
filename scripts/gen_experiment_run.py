...
/data/anon/paper_runs/experiments/<run_id>/, mirrors it to
...
BERGSON = "/data/anon/bergson-main-paper-429"
...
DATA = "/data/anon/bergson-damping/runs/ekfac_vs_n/datasets"
...
# process cannot be killed. That is what stranded six A100s on node-x-0:
...
RUNS_SSD2 = "/data/anon/paper_runs/experiments"
RUNS_SSD1 = "/data/anon/paper_runs/experiments"
...
def main() -> None:
    ...
    print(f"cd /tmp && CUDA_VISIBLE_DEVICES=<gpus> MASTER_PORT=<unique> PYTHONNOUSERSITE=1 \\\n"
          ...
          f"  /data/anon/envs/paper/bin/python -s -P -m bergson {cfg_path}")
