...
| control | value | why |
|---|---|---|
| corpus | SmolLM2 512-token chunks (`anonymous/bergson-smollm2-lds-chunks` lineage) | **WikiText is banned from paper runs — it does not scale**; builder asserts `dataset == smollm2` |
...
`/data/anon/s16k_lrsweep/`, one factor = lr; untrained gpt2 = 3.4981):
