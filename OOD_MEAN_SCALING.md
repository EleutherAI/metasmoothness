...
The OOD scaling artifacts live under `/data/anon/ood_mean_scaling`.

## Fixed queries

- WikiText-103: `/data/anon/wikitext103_ood/query_50_mean.hf`
- BioForget: `/data/anon/ood_mean_scaling/bioforget/query_50_mean.hf`
