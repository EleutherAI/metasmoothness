...
only in `/data/anon/bergson-damping/scripts/ekfac_vs_n/`, the Hub copy has a
...
## The recipe
    ...
    corpus     anonymous/SmolLM2-135M-10B   (10,058,156 raw docs)
...
## Where things live
    ...
    query_20/50.hf  /data/anon/datasets_local
    train_*.hf      /data/anon/datasets_local
    Hub             anonymous/bergson-smollm2-scaling  (4k..256k only; no 512k/1M)
