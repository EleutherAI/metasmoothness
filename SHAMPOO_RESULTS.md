...
[bergson PR #384](https://github.com/anonymous/bergson/pull/384) (`feat/rank-pseudoinverse-inversions`,
...
- **adam bank:** `/data/anon-adam-shampoo/run_adam/N4k` — GPT-2 ft, adam, eps_root 1e-6, N=4k,
  bs64, 2 epochs, dropout 0.1 (inert), `rep` shuffle; metasmoothness 0.991. 100 subsets @1%.
- **muon bank:** `/data/anon/muon4k/run/N4k` — eps_root 1e-6, lr 5e-5, 4 epochs; metasmooth 0.997.
- **large-update muon bank:** `/data/anon/muon4k/run_3e-4/N4k` — eps_root 1e-6, lr 3e-4,
...
|---|--------|-------------|-----------|-----|--------|-------------------|---------|
| 1 | `shampoo_quarter` (canonical Jul-20, pre-#384) | — | damped 0.1 | 0.3264 | [0.292, 0.359] | — | `anon-adam-shampoo/shampoo_quarter_adam` |
| 2 | `shampoo` (#384) | −0.5 | damped 0.1 | 0.3262 | [0.292, 0.358] | −0.0001 [−0.0018, +0.0016] | `anon/shampoo_rohan_adam_p05` |
| 3 | `shampoo` (#384) | −0.5 | damped 0.1 | 0.3246 | [0.291, 0.357] | −0.0018 [−0.0035, −0.0001] | `anon/shampoo_rohan_adam_p0.5_damped` |
| 4 | `shampoo` (canonical, old) | — | damped 0.1 | 0.3071 | [0.272, 0.341] | −0.0193 [−0.035, −0.003] | `anon-adam-shampoo/shampoo_adam` |
| 5 | `kfac` (canonical, old) | — | damped 0.1 | 0.3156 | [0.283, 0.347] | −0.0108 [−0.022, −0.000] | `anon-adam-shampoo/ekfac_adam` |
...
Run dirs: `/data/anon/shampoo_rohan_{adam,muon}*` (`_damped`, `_dampedref`, `_p05`,
`_p0.5_damped`, `_p0.5_pinv`, `_rtol*`), `/data/anon/shampoo_muon5e5_p05_{pinv,damped}`,
`/data/anon/shampoo_muon3e4_{pinv,damped}` and `shampoo_muon3e4_p{1.0,0.25}_{pinv,damped}`.
Metasmoothness for the lr3e-4 bank: `/data/anon/muon4k/metasmooth_muon_3e-4` (running).
